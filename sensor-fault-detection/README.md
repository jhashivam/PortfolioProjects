...
```bash
git clone https://github.com/jhashivam/sensor-fault-detection.git
```
...
export MONGO_DB_URL="mongodb+srv://shivamjha:mongodb@cluster0.kzqhnhm.mongodb.net/?retryWrites=true&w=majority"
